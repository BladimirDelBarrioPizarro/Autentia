...
public class CourseServiceDummy {
    ...
    public static List<Course> courseListDummy(){
        return Arrays.asList(
                new Course("React",false, "Rubén Aguilera", "Intermedio",10),
                new Course("Introducción a JSF 2",true, "Roberto Canales", "Intermedio",25),
                new Course("Clean Code",false, "Robert C Martin", "Básico",10),
                new Course("Novedades en Java 8",true, "David Goméz", "Básico",10),
                new Course("Java para sistemas",true, "Alberto Moratilla", "Básico",25),
                new Course("Angular 2",true, "Rubén Aguilera", "Intermedio",25)
        );
    }
